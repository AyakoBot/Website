	...
	<div class="flex flex-col gap-1 flex-1 min-w-0">
		...
		<div class="msg-embed flex rounded overflow-hidden max-w-100 mt-1">
			...
			<div class="bg-[#2b2d31] p-2 px-3 pb-2 flex flex-col flex-1">
				...
				<div class="mt-1">
					<span class="block text-3.25 font-700 text-white">Required Role to enter this Giveaway</span>
...
<div class="relative flex gap-4 py-0.5 mt-2">
		...
		<div class="msg-embed flex rounded overflow-hidden max-w-100 mt-1">
			...
			<div class="bg-[#2b2d31] p-2 px-3 pb-3 flex flex-col gap-1 flex-1">
				...
				<span class="text-3.25 text-white/75 mt-1"
					>Go to the Giveaway and click <code class="bg-[#1e1e1e] px-1 rounded text-2.75">Claim</code> to claim
					your Prize</span
				>
				<span class="text-3.25 text-white/75"
	...
	>
		<span
			...
			>Set role requirements<br />for entry</span
		>
		<svg
	...
	>
		...
		<span
			class="[font-family:'Caveat','Comic_Neue',cursive] text-[17px] font-600 text-[#fde047] leading-[1.2] whitespace-nowrap [text-shadow:0_0_8px_rgba(0,0,0,1),0_0_16px_rgba(0,0,0,0.9),0_0_32px_rgba(0,0,0,0.8),0_2px_4px_rgba(0,0,0,1)]"
			>Fair winner selection<br />with automatic payout<br />on expiry</span
		>
	</div>
</div>
