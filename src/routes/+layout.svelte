...
<div
	id="main"
	class="of-hidden flex flex-col justify-between items-center min-h-full text-center break-normal select-none min-h-100vh min-w-100vw bg-gradient-linear bg-gradient-[142deg,rgba(0,0,0,1)_0%,rgba(98,14,14,1)_73%] bg-[100%100%]
